...
<body topmargin="0">
	...
	<div id="container">
		<h1>Session Failover Test Page</h1>

		<div id="body">
			<p>Session info :</p>
			<div>
				JSESSIONID<font color=red>.JvmRoute</font> :
				<%=session.getId()%></div>
			<div>
				CREATION TIME :
				<%=session.getCreationTime()%></div>
			<div>
				TIMEOUT IN SEC :
			...
			<div id="colLine">
				<div class="ddiv">
					<div style="text-align: center">
						You have hit this page <BR />
						<BR /> <font color=red size=15> <%=ival%></font> time<%=(ival.intValue() == 1) ? "" : "s"%>, <BR /> before the session times out.
					</div>
					<div style="text-align: center">
						You have hit this page a total of <BR />
						<BR /> <font color=green size=15> <%=cnt%></font> time<%=(cnt.intValue() == 1) ? "" : "s"%>!
					</div>
				</div>
			</div>
			<div style="clear: both;"></div>
